...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Edit Pengembalian Dana</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('admin.dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item active"><a href="{{ route('admin.transaksi.index') }}">Data Pengembalian Dana</a>
                </div>
                <div class="breadcrumb-item">Edit Pengembalian Dana</div>
            </div>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.pengembalian-dana.update', $item->id) }}" method="post">
                                @csrf
                                @method('patch')
                                <div class='form-group mb-3'>
                                    ...
                                    <input type='text' name='kode'
                                        ...
                                        value='{{ $item->tiket->kode ?? old('kode') }}' disabled>
                                    @error('kode')
                                ...
                                <div class='form-group mb-3'>
                                    ...
                                    <input type='text' name='konser'
                                        ...
                                        value='{{ $item->tiket->transaksi->konser->nama ?? old('konser') }}' disabled>
                                    @error('konser')
                                        <div class='invalid-feedback'>
                                            {{ $message }}
                                        </div>
                                ...
                                <div class='form-group mb-3'>
                                    ...
                                    <input type='text' name='bank'
                                        ...
                                        value=' {{ $item->nama_bank . ' - ' . $item->nomor_rekening . ' (' . $item->pemilik . ')' }}'
                                        disabled>
                                    @error('bank')
                                        <div class='invalid-feedback'>
                                            {{ $message }}

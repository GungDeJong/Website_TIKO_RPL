            ...
            <div class="row">
                ...
                <div class="col-md">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.artis-konser.create', [
                                    ...
                                    <tbody>
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->artis->nama }}</td>
                                                <td>{{ $item->artis->genre }}</td>
                                                <td>{{ $item->artis->album_terkenal }}</td>
                                                <td>
                                                    <form action="" method="post" class="d-inline" id="formDelete">
                                                        @csrf
                                                        @method('delete')
                                                        <button
                                                            data-action="{{ route('admin.artis-konser.destroy', $item->id) }}"
